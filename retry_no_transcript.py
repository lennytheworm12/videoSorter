...
Usage:
    python retry_no_transcript.py              # all roles
    python retry_no_transcript.py --role top   # one role
    python retry_no_transcript.py --dry-run    # show counts without retrying
"""
